...
void list_clear(struct reg_list *p) { p->len = 0; }
...
size_t list_len(struct reg_list *p) { return p->len; }
...
void list_sort_subset(struct reg_list *p, size_t begin_idx, size_t len,
                      campar sort) {
